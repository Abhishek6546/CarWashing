    ...
    <>
      ...
      <div
        className={`
          ...
          w-72 p-4 overflow-y-auto z-50 transition-all duration-300 ease-in-out shadow-xl lg:shadow-lg lg:rounded-xl
      ...
      >
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-1">
            ...
            <button
              onClick={onToggle}
              className="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-all lg:hidden"
            >
              <X className="h-3 w-3" />
            </button>
          </div>
        ...
        <div className="space-y-4">
          {/* Service Type */}
          <div>
            <label className="flex items-center space-x-1 text-xs font-semibold text-gray-700 mb-1">
            ...
            <div className="grid grid-cols-3 gap-1.5">
              {carTypes.map((type) => (
                <button
                  key={type.value}
                  onClick={() =>
                    handleFilterChange('carType', localFilters.carType === type.value ? '' : type.value)
                  }
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {statuses.map((status) => (
                <button
                  ...
                  className={`p-2 rounded-md border text-xs font-medium text-left ${
                ...
                >
                  <span className={`inline-block px-1.5 py-0.5 rounded-full text-xs ${status.color}`}>
                    {status.label}
                  </span>
                </button>
              ))}
          ...
          <div>
            ...
            <div className="space-y-2">
              <input
                type="date"
                className="w-full px-3 py-2 bg-white/80 border border-gray-200 rounded-md text-sm text-gray-700 focus:ring-1 focus:ring-orange-500 focus:border-orange-500 transition-all hover:border-orange-300"
          ...
          {hasActiveFilters && (
            <div className="pt-4 border-t border-gray-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-2 py-0.5 rounded-full text-xs font-bold">
              ...
              <div className="space-y-1">
                {Object.entries(localFilters).map(([key, value]) => {
                  ...
                  return (
                    <div
                      key={key}
                      className="flex items-center justify-between p-1.5 bg-blue-50 rounded-md text-xs"
                    >
              ...
              <button
                onClick={clearFilters}
                className="w-full mt-2 px-3 py-1.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-md text-sm font-medium hover:from-red-600 hover:to-red-700 transition-all shadow-md"
              >
                Clear All
              </button>
            </div>
